  ...
  return (
    <div className="home-container">
      ...
      <div className = "mission">
        ...
        <p>"Our mission is to empower job-seekers by providing unbiased and intelligent resume analysis and educational resources. Using LLM AI technology and the scalability of MongoDB, we help students highlight their skills and experiences and connect them with potential employers. We help educate students by providing them with helpful resources that provide in-depth insight into resumes and the application process as a whole. We are here to make sure you qualifAI for your next job!"</p>
      </div>
      <br></br><br></br><br></br>
